...
If you ever need help, just reply directly on any email. My partner Lillian (6 🦄🏴‍☠️) and I are happy to lend a hand or introduce you to another more senior helper.

next, we look at how to create a page with the path date (❤️) from each of my old wordpress blog posts.

If you want you can wait with the list-of-ideas-for-tester thing and
jump straight into the first paper coding tiny task, just click on this link
